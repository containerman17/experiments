-- ================================================
-- ACTIVE ADDRESSES PER HOUR - HISTORICAL BACKFILL
-- ================================================
...
-- TRUNCATE TABLE active_addresses_per_hour;

-- Backfill all historical data
-- Note: Excluding the current/latest hour to avoid partial data
INSERT INTO active_addresses_per_hour (chain_id, hour, unique_addresses, computed_at)
...
OPTIMIZE TABLE active_addresses_per_hour FINAL;
...
FROM active_addresses_per_hour;
