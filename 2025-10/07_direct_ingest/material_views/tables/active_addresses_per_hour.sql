...
CREATE TABLE IF NOT EXISTS active_addresses_per_hour (
    chain_id UInt32,
    hour DateTime,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_active_addresses_per_hour
REFRESH EVERY 1 HOUR
TO active_addresses_per_hour
AS
WITH 
    latest_insert AS (
