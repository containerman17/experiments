-- ================================================
-- CUMULATIVE TX COUNT - HISTORICAL BACKFILL
-- ================================================
...
-- TRUNCATE TABLE cumulative_tx_count;

-- Backfill all historical data
-- Note: Excluding the current/latest day to avoid partial data
INSERT INTO cumulative_tx_count (chain_id, day, cumulative_tx_count, computed_at)
WITH 
    max_block_day AS (
...
OPTIMIZE TABLE cumulative_tx_count FINAL;
